...
void _cartModelAttach(IsarCollection<dynamic> col, Id id, CartModel object) {
  object.id = id;
  object.items.attach(col, col.isar.collection<CartItemModel>(), r'items', id);
}
...
extension CartModelQueryWhereSort
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhere> anyUserId() {
    return QueryBuilder.apply(this, (query) {
...
extension CartModelQueryWhere
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhereClause> userIdEqualTo(
      int userId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhereClause> userIdNotEqualTo(
      int userId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhereClause> userIdGreaterThan(
    int userId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhereClause> userIdLessThan(
    int userId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartModel, CartModel, QAfterWhereClause> userIdBetween(
    int lowerUserId,
    int upperUserId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CartModelQueryLinks
    on QueryBuilder<CartModel, CartModel, QFilterCondition> {
  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> items(
  ...
  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> itemsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> itemsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'items', 0, true, 0, true);
    });
  }

  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> itemsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'items', 0, false, 999999, true);
    });
  }

  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> itemsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartModel, CartModel, QAfterFilterCondition> itemsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
